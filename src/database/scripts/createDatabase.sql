...
ALTER TABLE "produtos" ADD FOREIGN KEY ("tipo_produto_id") REFERENCES "tipos_produtos" ("id");

ALTER TABLE "anuncios" ADD FOREIGN KEY ("estado_conservacao_id") REFERENCES "estados_conservacao" ("id");

ALTER TABLE "anuncios" ADD FOREIGN KEY ("produto_id") REFERENCES "produtos" ("id");
...
ALTER TABLE "fotos_produto" ADD FOREIGN KEY ("produto_cadastro_id") REFERENCES "anuncios" ("id");
